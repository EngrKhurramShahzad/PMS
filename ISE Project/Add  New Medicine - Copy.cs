...
namespace ISE_Project
{
    public partial class New : MetroFramework.Forms.MetroForm
    {
        ...
        private void bunifuThinButton24_Click(object sender, EventArgs e)
        {
            ...
            Obj.Salesmen_insertValues("Insert into Item_Table values('" + Convert.ToInt32(Item_Id.Text) + "','" + Item_Name.Text + "','" + Convert.ToInt64(Item_Price.Text) + "','" + Item_type.Text + "','" + Convert.ToInt64(Item_Quantity.Text) + "','" + Convert.ToInt64(Item_Brand.Text) + "','" + Convert.ToInt64(Item_Packing.Text) + "')");
